...
| 2 — Novel sweep | 5–10 | **✓ complete — H1-C HOLDS in all 3 Pythia sizes** (joint p = 0.00463 < 0.005 locked gate; 40 cells × 3 sizes × 3 motifs; bootstrap CIs on μ; `notebooks/h1c_ordering_test.ipynb` is the headline) |
