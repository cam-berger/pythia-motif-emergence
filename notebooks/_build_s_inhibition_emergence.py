...
def build() -> nbf.NotebookNode:
    ...
    nb["cells"] = [
        ...
        md(
            ...
            "\n"
            "**Where does each motif live?** The top-head layer trajectories "
            "show a consistent pattern at the final checkpoint:\n"
            "\n"
            "- Induction top heads sit at low-to-mid normalized depth (≈0.2-"
            "0.5 of the way through the model).\n"
            "- S-inhibition top heads sit at mid-to-high normalized depth "
            "(≈0.5-0.8). In Pythia-410m specifically, the top S-inhibition "
            "sender L12H12 is at normalized depth 0.52; in Pythia-160m the "
            "top S-inhibition head shifts between L8 and L6 (normalized "
            "depth 0.55-0.73); in Pythia-70m the top S-inhibition head is "
            "L4 (normalized depth 0.80).\n"
            "\n"
