"""Smoke test for the atlas-v1 PreviousTokenDetector.

Loads Pythia-410M-deduped @ step143000, runs the previous-token detector
...
surface a small number of clearly-previous-token heads at the final
checkpoint.

Run:
    uv run python notebooks/_run_atlas_previous_token_smoke.py
"""
...
def main() -> None:
    ...
    detector = PreviousTokenDetector()
    print(
