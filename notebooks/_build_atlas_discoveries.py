...
'''),
    ...
    md(
        ...
        "phenomena in the developmental-interpretability, attention-sink, scaling-laws,",
        "polysemanticity, and feature-competition literatures. Key references organized by theme:",
        "",
        ...
        "",
        "### Bigram circuits / skip-gram attention (Pattern 2)",
        "",
        "- **Chang & Bergen 2025.** *Bigram Subnetworks: Mapping to Next Tokens in Transformer",
        "  Language Models.* arXiv:2504.15471. → Identifies 'bigram subnetworks' in the first",
        "  MLP layer of trained LMs as the minimal circuit foundation. The k = −2 attention",
        "  heads we observe are likely the *attention-side analog* of these MLP bigram circuits:",
        "  both read information from one or two positions back to predict the next token.",
        "  [hf.co/papers/2504.15471](https://hf.co/papers/2504.15471)",
        "",
        "- **Lieberum et al. 2023.** *Does Circuit Analysis Interpretability Scale? Evidence",
        "  from Multiple Choice Capabilities in Chinchilla.* arXiv:2307.09458. → Methodological",
        "  precedent for cross-scale circuit analysis. Applied to 70B Chinchilla; we apply",
        "  similar analytic tools across Pythia's 70m–2.8b range.",
        "  [hf.co/papers/2307.09458](https://hf.co/papers/2307.09458)",
        "",
        "### Emergent capabilities and scaling laws (Pattern 4)",
        "",
        "- **Wei et al. 2022.** *Emergent Abilities of Large Language Models.* arXiv:2206.07682.",
        "  → Foundational paper on capability emergence at scale. We observe a finer-grained",
        "  emergence (motif counts) that compresses with size — a quantitative refinement of",
        "  the Wei emergence picture.",
        "  [hf.co/papers/2206.07682](https://hf.co/papers/2206.07682)",
        "",
        "- **Ruan et al. 2024.** *Observational Scaling Laws and the Predictability of Language",
        "  Model Performance.* arXiv:2405.10938. → Observational approach to scaling laws using",
        "  capability space + sigmoidal behavior. **Provides a framework for testing whether our",
        "  motif-count trajectories follow predictable scaling forms**.",
        "  [hf.co/papers/2405.10938](https://hf.co/papers/2405.10938)",
        "",
        "- **Hu et al. 2023.** *Unlock Predictable Scaling from Emergent Abilities (PassUntil).*",
        "  arXiv:2310.03262. → Strict task scaling law via critical-performance threshold.",
        "  Our emergence-step proxy is similar in spirit (first-step-passing-threshold).",
        "  [hf.co/papers/2310.03262](https://hf.co/papers/2310.03262)",
        "",
        "- **Snell et al. 2024.** *Predicting Emergent Capabilities by Finetuning.*",
        "  arXiv:2411.16035. → Uses parametric functions to forecast emergence step.",
        "  Methodological cousin of our emergence-step analysis.",
        "  [hf.co/papers/2411.16035](https://hf.co/papers/2411.16035)",
        "",
        "### Polysemanticity and superposition (multi-family heads)",
        "",
        "- **Elhage et al. 2022.** *Toy Models of Superposition.* arXiv:2209.10652. →",
        "  Foundational paper on polysemanticity / superposition; documents *phase changes*",
        "  between mono and polysemantic regimes as model capacity grows. **Directly explains",
        "  our finding** that multi-family head density is non-monotonic in scale (23% at 70m,",
        "  37% at 160m, 7.6% at 410m, 52% at 2.8b) — the 410m dip is a phase-transition trough.",
        "  [hf.co/papers/2209.10652](https://hf.co/papers/2209.10652)",
        "",
        "- **Cunningham et al. 2023.** *Sparse Autoencoders Find Highly Interpretable Features",
        "  in Language Models.* arXiv:2309.08600. → SAE-based decomposition reveals monosemantic",
        "  features hidden inside polysemantic neurons. Methodology that could resolve our",
        "  multi-family heads at 2.8b into their constituent features.",
        "  [hf.co/papers/2309.08600](https://hf.co/papers/2309.08600)",
        "",
        "- **Kissane et al. 2024.** *Interpreting Attention Layer Outputs with Sparse",
        "  Autoencoders.* arXiv:2406.17759. → Applies SAEs directly to attention outputs,",
        "  exposing polysemantic heads and identifying induction-feature directions.",
        "  **Most relevant for follow-up**: SAEs could decompose our 8-family typology into",
        "  per-feature directions and explain why some heads pass multiple families.",
        "  [hf.co/papers/2406.17759](https://hf.co/papers/2406.17759)",
        "",
        "### Feature competition / pruning / lottery ticket",
        "",
        "- **Frankle & Carbin 2018.** *The Lottery Ticket Hypothesis.* arXiv:1803.03635. →",
        "  Dense networks contain sparse subnetworks that succeed when trained in isolation.",
        "  **Analogy to our 410m collapse**: heads in the 'losing' lottery (delimiter) get",
        "  pruned of their broad attention; heads in the 'winning' lottery (BOS-sink) consolidate.",
        "  [hf.co/papers/1803.03635](https://hf.co/papers/1803.03635)",
        "",
        "- **Frankle et al. 2019.** *Stabilizing the Lottery Ticket Hypothesis.* arXiv:1903.01611.",
        "  → Iterative magnitude pruning with delayed pruning yields stable subnetworks. The",
        "  410m delimiter→BOS lock-in (steps 20000-29000) looks like an in-training",
        "  unstable→stable transition.",
        "  [hf.co/papers/1903.01611](https://hf.co/papers/1903.01611)",
        "",
        "- **Nguyen et al. 2025.** *CompeteSMoE — Statistically Guaranteed Mixture of Experts",
        "  Training via Competition.* arXiv:2505.13380. → Explicit competition mechanism for",
        "  expert routing. Conceptual analog to our head-budget competition picture.",
        "  [hf.co/papers/2505.13380](https://hf.co/papers/2505.13380)",
        "",
        ...
        "",
        "- **Marín 2025.** *A non-ergodic framework for understanding emergent capabilities.*",
        "  arXiv:2501.01638. → Frames capability emergence as discrete transitions in semantic",
        "  space via resource-constrained TAP dynamics. The 410m head-budget competition fits",
        "  this resource-constrained framing.",
        "  [hf.co/papers/2501.01638](https://hf.co/papers/2501.01638)",
        "",
        "### Synthesis",
        "",
        "The atlas-v1 findings sit naturally at the intersection of these literatures. Most",
        "patterns have *some* coverage; the gaps are documented in §8 below.",
    ),
    md(
        "## §8. Areas lacking explanation / candidate novel contributions",
        "",
        "After a literature pass across the developmental-interpretability, attention-sink,",
        "scaling-laws, polysemanticity, and feature-competition literatures, the following",
        "atlas-v1 findings appear to be **under-explained or not directly addressed** by published",
        "work. Each is worth a follow-up writeup or experimental validation.",
        "",
        "---",
        "",
        "### 8.1 The k = −2 universal dominance for positional-offset heads",
        "",
        "**Finding.** Across all 4 Pythia sizes, **>95% of positional-offset heads** (max",
        "non-(k=−1) attention ≥ 0.15) have dominant_k = −2. k = +1, +2, +3 are essentially absent.",
        "",
        "**Coverage in literature.** Chang & Bergen 2025 study 'bigram subnetworks' in the first",
        "MLP layer and identify them as the minimal circuit for next-token prediction. Olsson 2022",
        "documents the previous-token (k = −1) head as the induction scaffold. **No published",
        "work directly studies the attention-side k = −2 phenomenon as its own family.**",
        "",
        "**Why interesting.** Skip-1-backward attention is the natural *next step* in the chain:",
        "if previous-token heads provide 'what came before', k = −2 heads provide 'what came two",
        "steps before' — enabling skip-trigram and bigram-completion circuits. This may be the",
        "second tier of induction-circuit scaffolding.",
        "",
        "**Follow-up.** (i) Causal-ablation test: do k = −2 heads sit upstream of induction heads",
        "in the §H6-style functional graph? (ii) Layer-localization: are k = −2 heads consistently",
        "in early layers (where induction-prerequisite scaffolds live)?",
        "",
        "---",
        "",
        "### 8.2 The 410m competition regime as a phase transition",
        "",
        "**Finding.** Multi-family head density at 70m / 160m / 410m / 2.8b: 23% / 37% / **7.6%**",
        "/ 52% — non-monotonic, with a sharp dip at 410m. delim+BOS co-pass count: 0 / 27 / **1** /",
        "484 — exclusive competition at 410m only.",
        "",
        "**Coverage in literature.** Elhage 2022 *Toy Models of Superposition* documents phase",
        "changes between monosemantic and polysemantic regimes as toy-model capacity grows. Their",
        "framework predicts qualitatively similar phase transitions in real models, but does NOT",
        "predict a *specific scale* (e.g. 384 heads) where transitions cluster. **The Pythia-410m-",
        "specific phase transition for head specialization is not, to our knowledge, documented",
        "elsewhere.**",
        "",
        "**Why interesting.** If real, this means the pre-registered §H1-C triple straddles a",
        "phase transition, which complicates the interpretation of the ordering result. Some of",
        "the locked-detector ordering's tightness at 410m may be downstream of competition",
        "dynamics, not of motif structure.",
        "",
        "**Follow-up.** (i) Replicate at 250m / 350m / 500m on a different model family (GPT-2,",
        "Pythia variants) to see if the transition is at a fixed *parameter count* or fixed",
        "*head budget*. (ii) Train Pythia from scratch at 410m with a different head count and",
        "see if the competition regime moves.",
        "",
        "---",
        "",
        "### 8.3 The BOS-sink scale floor (Pythia-70m exception)",
        "",
        "**Finding.** Pythia-70m's max BOS-attention score is 0.39, never crossing the 0.50",
        "threshold. The BOS-sink phenotype does NOT form at this scale, while every other Pythia",
        "size has it as the dominant family.",
        "",
        "**Coverage in literature.** Ran-Milo 2026 *proves* attention sinks are *necessary* in",
        "softmax attention for trigger-conditional tasks. Su 2026 survey and Wong 2025 study",
        "their *formation dynamics*. **None of these works study minimum-scale onset.** The",
        "general assumption is sinks form; the *floor* at which they fail to form is open.",
        "",
        "**Why interesting.** If sinks are mathematically necessary above some scale, the floor",
        "is mechanistically interesting: it's the regime where softmax models exist but DON'T",
        "form sinks. Likely the model is doing something else (e.g., distributing attention",
        "across content tokens, which our 70m delimiter density at 44% confirms).",
        "",
        "**Follow-up.** Dose-response sweep across Pythia-14m → Pythia-70m → Pythia-125m → ",
        "Pythia-160m to localize the floor. Alternatively, train a Pythia-160m-shaped model with",
        "fewer heads to see if it's about parameter count or head count.",
        "",
        "---",
        "",
        "### 8.4 Transient over-emergence as a feature-competition signature",
        "",
        "**Finding.** Six (size, family) cells show peak/final ratios > 1.5, all clustered at",
        "410m and 2.8b:",
        "",
        "    delimiter @ 410m         4.69",
        "    successor @ 410m         3.50",
        "    positional_offset @ 2.8b 2.15",
        "    positional_offset @ 160m 1.71",
        "    positional_offset @ 410m 1.64",
        "    successor @ 2.8b         1.56",
        "",
        "70m has zero cases. The pattern is *exploration before commitment*: heads briefly",
        "occupy a functional role, then specialize away.",
        "",
        "**Coverage in literature.** Frankle 2018 *Lottery Ticket* and follow-ups describe sparse",
        "subnetwork survival during pruning, but those are weight-level, not feature-level. Hu",
        "2023 *Latent State Models* discusses 'detour states' during training (HMM-detected",
        "transient phases) — closest match. Elhage 2022 *Toy Models* describes phase-change",
        "dynamics but in equilibrium, not transient. **No paper appears to systematically study",
        "head-level transient over-emergence as a training-dynamics signature.**",
        "",
        "**Why interesting.** This is the closest empirical analog to *neural pruning* in",
        "developmental neuroscience (Huttenlocher synaptic over-production + pruning). It's a",
        "concrete training-dynamics phenomenon that connects mech-interp to developmental",
        "science — worth a careful empirical writeup.",
        "",
        "**Follow-up.** (i) Build a 'pruning curve' diagnostic: per-(size, family) report peak,",
        "final, peak-step, and pruning rate (peak − final) / (max_step − peak_step). (ii) Test",
        "whether transient-over-emergent heads are causally relevant during their transient peak",
        "(via early-checkpoint ablation).",
        "",
        "---",
        "",
        "### 8.5 The successor heads' partial collapse at 410m (peak 7 → final 2)",
        "",
        "**Finding.** §H1-C-locked successor heads at 410m peak at 7 at step 20000 and drop to 2",
        "at step 143000 (ratio 3.50). Of the 5 dropped heads:",
        "  - L12H8, L13H5 → become BOS-attention heads",
        "  - L20H4, L22H8, L23H13 → become unaffiliated (no atlas family passes)",
        "",
        "**Coverage in literature.** No published work tracks per-head functional reassignment",
        "between specific motif types during training. Gould 2024 *Successor Heads* identified",
        "successor heads at single checkpoints but didn't follow them through training. **The",
        "successor → unaffiliated transition is novel observation.**",
        "",
        "**Why interesting.** The 'unaffiliated' destination is mysterious — if the head doesn't",
        "pass any of our 8 families at convergence, what is it doing? Possibilities: (i) it does",
        "a finer-grained role our detectors miss (e.g., specific-token attention), (ii) it's",
        "doing nothing important (causally inert), (iii) it's doing something that requires a",
        "9th detector we haven't built.",
        "",
        "**Follow-up.** (i) Causal ablation of L20H4, L22H8, L23H13 at Pythia-410m to test",
        "whether they're functionally inert. (ii) Build a 'residual feature' detector that finds",
        "what monosemantic feature these heads encode (SAE-based, à la Kissane 2024).",
        "",
        "---",
        "",
        "### 8.6 Cross-scale family-density rank reordering",
        "",
        "**Finding.** Family ranking by density at convergence is NOT stable across sizes:",
        "",
        "    70m:  delimiter > previous_token > induction = positional_offset > duplicate_token",
        "    160m: delimiter > bos_attention > previous_token > induction > positional_offset",
        "    410m: bos_attention > delimiter > previous_token > induction > positional_offset",
        "    2.8b: bos_attention ≈ delimiter > previous_token > induction > positional_offset",
        "",
        "Each transition between sizes involves some rank shuffling, but the *macro* trend",
        "(BOS+delim rising, positional + induction falling) is monotone.",
        "",
        "**Coverage in literature.** Wei 2022 and Snell 2024 cover capability emergence vs scale;",
        "Ruan 2024 covers performance scaling. **No paper covers RANK shuffling of internal",
        "phenotypes across scales as the dominant phenotypic story shifts.** This is a finer-",
        "grained reading of the scaling story than 'capabilities emerge'.",
        "",
        "**Follow-up.** A formal rank-correlation analysis (Kendall's τ between consecutive size",
        "rankings) would quantify the shuffle rate. If shuffling is biggest at 70m → 160m and",
        "smaller at 410m → 2.8b, that's evidence the early-scale regime is qualitatively",
        "different from the large-scale regime.",
        "",
        "---",
        "",
        "### Summary of candidate novel contributions",
        "",
        "Across the 5 patterns and the open puzzle, the strongest candidate novel contributions",
        "(in rough order of how surprising they are vs published work):",
        "",
        "1. **§8.2 The 410m competition regime** — Pythia-specific phase transition for head",
        "   specialization, with the §H1-C ordering result implicated in it.",
        "2. **§8.3 The BOS-sink scale floor at 70m** — minimum scale for sink formation in",
        "   softmax models.",
        "3. **§8.1 k = −2 dominance for positional-offset heads** — specific scaffolding family",
        "   not previously named.",
        "4. **§8.4 Transient over-emergence as a feature-competition signature** — empirical",
        "   analog to developmental pruning at the head level.",
        "5. **§8.5 Successor head 410m partial collapse** — first per-head functional",
        "   reassignment tracked through training for any motif.",
        "",
        "Patterns 1 (density trajectories), 4 (compression with scale), and 5 (developmental",
        "order) are well-supported by published work but extended in the atlas's cross-motif",
        "framing.",
    ),
]
