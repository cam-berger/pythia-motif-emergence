...
def build() -> nbf.NotebookNode:
    ...
    nb["cells"] = [
        ...
        code(
            "df_ind = pd.concat([read_long(sweep_path('induction', s)) for s in SIZES]).reset_index(drop=True)\n"
            "df_suc = pd.concat([read_long(sweep_path('successor', s)) for s in SIZES]).reset_index(drop=True)\n"
            "df_si = pd.concat([read_long(sweep_path('s_inhibition', s)) for s in SIZES]).reset_index(drop=True)\n"
            "\n"
