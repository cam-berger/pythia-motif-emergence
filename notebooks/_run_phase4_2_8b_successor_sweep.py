"""Phase 4 2.8B successor sweep — 40 cells × Pythia-2.8B-deduped (HYPOTHESIS.md §H4-scaling).

Outputs:
  - data/exploration/phase4_2_8b_successor_sweep.parquet
  - data/exploration/phase4_2_8b_successor_per_prompt/2.8b_step{step}.npz
"""
...
OUT_PARQUET = (
    REPO_ROOT / "data" / "exploration" / "phase4_2_8b_successor_sweep.parquet"
)
OUT_NPZ_DIR = REPO_ROOT / "data" / "exploration" / "phase4_2_8b_successor_per_prompt"
