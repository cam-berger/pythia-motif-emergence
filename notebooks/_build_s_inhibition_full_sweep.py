...
def build() -> nbf.NotebookNode:
    ...
    nb["cells"] = [
        ...
        md(
            ...
            "\n"
            "Vary the locked threshold (τ_strict = 0.0372) by ± 25% in 5 increments "
            ...
            "threshold mis-specification. The 2.8b column uses the §H4-supersede "
            "10-cell grid per §writeup-conv-4; its CI is wider than the 40-cell sizes "
            "owing to fewer fit anchors."
        ),
        code(
